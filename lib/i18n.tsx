...
const translations = {
  en: {
    ...
    // Tickets
    tickets: "Tickets",
    ticketsSubtitle: (n: number) => `${n} ticket(s)`,
    newTicket: "New ticket",
    ticketSubject: "Subject",
    ticketMessage: "Message",
    ticketEmail: "Your email",
    ticketEmailPlaceholder: "email@example.com",
    ticketSubjectPlaceholder: "Describe your issue...",
    ticketSend: "Send",
    ticketCodeTitle: "Check your emails!",
    ticketCodeSubtitle: "Enter the 6-digit code sent to",
    ticketCodePlaceholder: "123456",
    ticketAccessTicket: "Access ticket",
    ...
    ticketClosed: "Closed",
    serverPerms: "Server access",
    // Accounting
    accounting: "Accounting",
    accountingSubtitle: "Financial overview",
  ...
  fr: {
    ...
    ticketEmailPlaceholder: "email@exemple.com",
    ticketSubjectPlaceholder: "Décrivez votre problème...",
    ticketSend: "Envoyer",
    ticketCodeTitle: "Vérifiez vos emails !",
    ticketCodeSubtitle: "Entrez le code à 6 chiffres envoyé à",
    ticketCodePlaceholder: "123456",
    ticketAccessTicket: "Accéder au ticket",
    ...
    ticketClosed: "Fermé",
    serverPerms: "Accès serveurs",
    // Accounting
    accounting: "Comptabilité",
    accountingSubtitle: "Vue financière",
    balance: "Solde actuel",
    income: "Entrées",
    expense: "Sorties",
    transactions: "Transactions",
    addTransaction: "Ajouter une transaction",
    transactionLabel: "Libellé",
    transactionDate: "Date",
